...
//     You need to create a function which returns a string which summarizes the result of the lightbulb.
...
/* ------------------------------------------------
    ...
    Given a lightbulb's result, create a switch statement which returns 
    a nicely formatted user readable string.

    A lightbulb can have any of the following resultes:
...
console.log(getLightBulbresultDisplayString("on") === "The house is bright!");
console.log("* Check for off");
console.log(getLightBulbresultDisplayString("off") === "The house is dark");
console.log("* Check for dimmed");
console.log(
  getLightBulbresultDisplayString("dimmed") === "The house is nice and dim"
);
console.log("* Check for offline");
console.log(
  getLightBulbresultDisplayString("offline") ===
    "The house is dark and we can't find the lightbulb!"
);
console.log("* Check for missing");
console.log(
  getLightBulbresultDisplayString("missing") ===
    "The house is dark and we can't find the lightbulb!"
);
console.log("* Check for deleted");
console.log(
  getLightBulbresultDisplayString("deleted") ===
    "The lightbulb has been removed from the system"
);
console.log("* Check for broken");
console.log(
  getLightBulbresultDisplayString("broken") ===
    "The house is dark and we can't turn the light on!"
);
console.log("* Check for empty string");
console.log(getLightBulbresultDisplayString("") === "Something is wrong!");
console.log("* Check for 5");
console.log(getLightBulbresultDisplayString(5) === "Something is wrong!");
console.log("* Check for false");
console.log(getLightBulbresultDisplayString(false) === "Something is wrong!");
